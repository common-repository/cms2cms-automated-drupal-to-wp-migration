...
class CmsPluginFunctionsDrupal
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback" : "//wordpress.org/support/plugin/cms2cms-automated-drupal-to-wp-migration/reviews/",
    ...
    {
        $cms2cms_drupal_access_login = get_option('cms2cms-drupal-login');
        $cms2cms_drupal_access_key   = get_option('cms2cms-drupal-key');
    ...
    {
        $key   = get_option('cms2cms-drupal-key');
        $login = get_option('cms2cms-drupal-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-drupal-key', $key);

            delete_option('cms2cms-drupal-login');
            add_option('cms2cms-drupal-login', $login);

            delete_option('cms2cms-drupal-depth');
            add_option('cms2cms-drupal-depth', $bridge_depth);
