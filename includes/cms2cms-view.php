<?php
if (!defined('CMS2CMS_DRUPAL_VERSION')) {
    die();
}
...
$styles = array($dataProvider->getFrontUrl() . 'css/cms2cms.css?v=' . CMS2CMS_DRUPAL_VERSION);
foreach ($styles as $style) {
    printf('<link rel="stylesheet" href="%s" type="text/css" media="all">', $style);
}

$scripts = array(
    $dataProvider->getFrontUrl() . 'js/jsonp.js?v=' . CMS2CMS_DRUPAL_VERSION,
    $dataProvider->getFrontUrl() . 'js/cms2cms.js?v=' . CMS2CMS_DRUPAL_VERSION
);
            ...
            <div class="cms2cms-drupal-message">
                <span>
                    <?php echo sprintf(
                        ...
                        get_option('cms2cms-drupal-login')
                    ); ?>
                </span>
